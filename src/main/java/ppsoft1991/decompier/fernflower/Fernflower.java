...
import ppsoft1991.decompier.fernflower.FernflowerStructContext;
...
public class Fernflower implements IDecompiledData {
    ...
    public Fernflower(IBytecodeProvider provider, IResultSaver saver, Map<String, Object> customProperties, IFernflowerLogger logger) {
        ...
        // 使用我们自定义的context
        structContext = new FernflowerStructContext(saver, this, new LazyLoader(provider));
    ...
    private static IIdentifierRenamer loadHelper(String className, IFernflowerLogger logger) {
        if (className != null) {
            try {
                Class<?> renamerClass = org.jetbrains.java.decompiler.main.Fernflower.class.getClassLoader().loadClass(className);
